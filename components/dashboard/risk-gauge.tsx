...
const GLOW_CLASS: Record<string, string> = {
  danger: "drop-shadow-[0_0_20px_var(--danger-glow)]",
  warning: "drop-shadow-[0_0_20px_var(--warning-glow)]",
  caution: "drop-shadow-[0_0_20px_var(--caution-glow)]",
  safe: "drop-shadow-[0_0_20px_var(--safe-glow)]",
};
